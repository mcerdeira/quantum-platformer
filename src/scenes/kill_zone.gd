...
func _on_body_entered(body):
	if body and (body.is_in_group("enemies") or body.is_in_group("players") or body.is_in_group("interactuable_coin") or body.is_in_group("interactuable")):
		if Global.TerminalNumber == Global.TerminalsEnum.LEAF or Global.TerminalNumber == Global.TerminalsEnum.SALAMANDER:
