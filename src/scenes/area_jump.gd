...
func _physics_process(delta):
	...
	for body in overlapping_bodies:
		if (body.is_in_group("enemies") or body.is_in_group("interactuable_coin") or body.is_in_group("players") or body.is_in_group("interactuable")):
			...
			body.super_jump()
			if Global.TerminalNumber == Global.TerminalsEnum.SALAMANDER or Global.TerminalNumber == Global.TerminalsEnum.TOMB or Global.TerminalNumber == Global.TerminalsEnum.MERMAID:
